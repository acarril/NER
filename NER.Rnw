...
library(knitr)
library(highr)
knitr::opts_chunk$set(cache = TRUE, comment = '#>', fig.path="figs/", fig.width=4.8, fig.height=3.6, out.width="4in", out.height="3in", fig.align='center', fig.pos = "htb", dev='pdf')
...
\date{Versión 1.1.\Sexpr{as.numeric(format(Sys.Date(tz="UTC"),"%Y%m%d"))} \\ \vfill
