...
\hlkwa{for}\hlstd{(i} \hlkwa{in} \hlnum{1}\hlopt{:}\hlstd{muestras) \{}
  ...
  \hlstd{beta0[i]} \hlkwb{<-} \hlstd{estimacion}\hlopt{$}\hlstd{coef[}\hlnum{1}\hlstd{]} \hlcom{# guardar intercepto estimado de esta iteración}
  \hlstd{beta1[i]} \hlkwb{<-} \hlstd{estimacion}\hlopt{$}\hlstd{coef[}\hlnum{2}\hlstd{]} \hlcom{# guardar pendiente estimada de esta iteración}
\hlstd{\}}
