...
%Implícitamente en estos ejemplos definimos $x$ e $y$ como una columna de datos, o un vector. Volveremos sobre este punto en breve.
...
\subsection*{Resumen/Nuestro objetivo}
...
simdatos <- read.csv("datos/simdatos.csv")
head(simdatos)
@
